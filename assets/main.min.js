...
swiper_core__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper_core__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper_core__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper_core__WEBPACK_IMPORTED_MODULE_0__.EffectFade, swiper_core__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper_core__WEBPACK_IMPORTED_MODULE_0__.Manipulation]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  ...
  return {
    ...
    init: function init() {
      var _this = this;
      var el = ops.target ? document.querySelector(ops.target) : this.$el;
      this.config = Object.assign({
        slidesPerView: "auto",
        createElements: true
      }, ops);
      _toConsumableArray(el.children).forEach(function (child) {
        return child.classList.add('swiper-slide');
      });
      this.swiper = new swiper_core__WEBPACK_IMPORTED_MODULE_0__["default"](el, this.config);
      this.swiper.on('slideChange', function () {
        _this.$nextTick(function () {
          _this.current = _this.swiper.realIndex;
        });
      });
    },
    appendSlides: function appendSlides(slides) {
...
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
var setupObserver = function setupObserver(elements) {
  var observer = window.revealObs || new IntersectionObserver(function (entries, observer) {
  ...
  var unobserveAll = function unobserveAll(event) {
    elements.forEach(function (el) {
...
var loadEl = function loadEl(el) {
  el.classList.add("s--revealed");
  el.dispatchEvent(new CustomEvent("revealed"));
  if (el.dataset.reveal.length) {
    _toConsumableArray(document.querySelectorAll(el.dataset.reveal)).forEach(function (t) {
...
var init = function init() {
  ...
  var elements = _toConsumableArray(document.querySelectorAll("[data-reveal]"));
...
function splide() {
  ...
  return {
    ...
    init: function init() {
      var _this = this;
      var el = opts.el || this.$el;

      // initialise splide
      this.splide = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__.Splide(el, this.options.splide);
      ...
      this.splide.on('drag', function () {
        _this.splide.root.classList.add('is-dragging');
      });
      this.splide.on('dragged', function () {
        _this.splide.root.classList.remove('is-dragging');
      });
    ...
    checkActive: function checkActive() {
      ...
      this.active = !this.splide.is(_splidejs_splide__WEBPACK_IMPORTED_MODULE_0__.Splide.STATES.DESTROYED);
    },
    checkArrowVisibility: function checkArrowVisibility(el) {
      var arrows = el.querySelector('.splide__arrows');
      if (!arrows) return false;
      var hiddenSlides = el.querySelectorAll('.splide__slide:not(.splide__slide--clone):not(.is-visible)');
...
/* harmony import */ var _components_reveal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/reveal */ "./src/js/components/reveal.js");
...
window.addEventListener("DOMContentLoaded", function () {
  (0,_components_reveal__WEBPACK_IMPORTED_MODULE_1__["default"])({
    // defaultClass: "-reveal",
    observerOptions: {
...
var map = {
	...
	"./reveal.js": "./src/js/components/reveal.js",
	"./splide.js": "./src/js/components/splide.js"
};
...
/******/ 	__webpack_require__.O(undefined, ["assets/main.min"], () => (__webpack_require__("./src/js/main.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/main.min"], () => (__webpack_require__("./src/css/main.css")))
